...
import { ProvinceImportItemComponent } from '../province-import-item/province-import-item.component';
...
export class ProvinceComponent implements OnInit {
  ...
  @ViewChild(ProvinceItemComponent, { static: false }) itemModal;
  @ViewChild(DeleteModalComponent, { static: false }) deleteModal;
  @ViewChild(ProvinceImportItemComponent, { static: false }) importModal;
  ...
  tittle = 'Danh sách tỉnh thành phố';
  ...
  initRightOfUser() {
    // this.btnAdd.GrandAccess = this.userRightService.check('UNIT-ADD');
  }
  ...
  deleteListItem(listId: [string]) {
    ...
    const promise = this.provinceService.delete(listId).subscribe(
      (res: any) => {
  ...
  initGridData() {
    ...
    const rs = this.provinceService.getFilter(this.filter).subscribe(
      (res: any) => {
